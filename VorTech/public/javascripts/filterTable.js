...
function filterAulas() {
    ...
    filter = input.value.toUpperCase();
    table = document.getElementById("aulas");
    tr = table.getElementsByTagName("tr");
    for (i = 0; i < tr.length; i++) {
...
function filterDocente() {
    var input, filter, table, tr, td, i, txtValue;
    input = document.getElementById("filterDocente");
    filter = input.value.toUpperCase();
    table = document.getElementById("salas");
    tr = table.getElementsByTagName("tr");
    for (i = 0; i < tr.length; i++) {
      td = tr[i].getElementsByTagName("td")[3];
      if (td) {
...
function filterMaterial() {
    ...
    filter = input.value.toUpperCase();
    table = document.getElementById("materiais");
    tr = table.getElementsByTagName("tr");
    for (i = 0; i < tr.length; i++) {
      td = tr[i].getElementsByTagName("td")[1];
      if (td) {
...
function filterMaterialSala() {
    var input, filter, table, tr, td, i, txtValue;
    input = document.getElementById("filterMaterialSala");
    filter = input.value.toUpperCase();
    table = document.getElementById("materiais");
    tr = table.getElementsByTagName("tr");
    for (i = 0; i < tr.length; i++) {
